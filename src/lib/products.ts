...
const products: Product[] = [
  ...
  },
  {
    ...
    description:
      'The ultimate tool for creators. This laptop is built to handle demanding creative workflows with its color-accurate display, powerful GPU, and extensive port selection. Whether you\'re into video editing, 3D rendering, or graphic design, this machine has you covered.',
    price: 2500.0,
    images: ['https://placehold.co/600x600.png', 'https://placehold.co/600x600.png'],
    category: 'Laptops',
    stock: 8,
